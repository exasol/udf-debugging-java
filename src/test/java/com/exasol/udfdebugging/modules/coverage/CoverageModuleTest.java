...
class CoverageModuleTest {
    ...
    void testUpload() throws InterruptedException, BucketAccessException, TimeoutException {
        ...
        new CoverageModule((port) -> new HostPortProxy("1.2.3.4", port), bucket);
    ...
    void testGetJvmOptions() {
        ...
        final CoverageModule coverageModule = new CoverageModule((port) -> new HostPortProxy("1.2.3.4", port), bucket);
